...
use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_12_PUB_22_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_12_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_12_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_12_PUB_22_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_12_PUB_22_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_51, transcript.shplonk_z.into(), scalar_52,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 24 proof points
            for point in points.slice(28, 24) {
                assert(
