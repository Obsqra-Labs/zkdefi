// LendingAdapter: Mock strategy adapter wrapping a lending protocol.
//
// In production this contract would deposit into the LendingPool contract
// (see lending_pool.cairo) and earn supply interest. On Sepolia the adapter
// uses internal bookkeeping so the VaultController rebalancing pipeline can
// operate without a live lending market.
...
mod LendingAdapter {
    ...
    #[abi(embed_v0)]
    impl LendingAdapterImpl of crate::strategy_adapter::IStrategyAdapter<ContractState> {
