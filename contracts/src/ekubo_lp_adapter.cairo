// EkuboLpAdapter: Mock strategy adapter for Ekubo LP positions on Sepolia.
//
// In production this contract would interact with the Ekubo AMM to provide
// concentrated-liquidity LP positions. On Sepolia the adapter simulates
// deposits/withdrawals with internal bookkeeping so the VaultController can
// exercise the full rebalancing pipeline without live Ekubo calls.
...
mod EkuboLpAdapter {
    ...
    #[abi(embed_v0)]
    impl EkuboLpAdapterImpl of crate::strategy_adapter::IStrategyAdapter<ContractState> {
