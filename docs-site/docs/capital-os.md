...
- Hand off prepared context to [Trade Desk](/trade-desk) for execution.
...
1. Connect wallet and complete onboarding prompts.
2. Open `/profile` and confirm trust/reputation readiness.
3. Return to `/agent` and validate:
- capital posture
- policy/gate status
- health signals
...
5. Hand off to [Trade Desk](/trade-desk) for route selection and execution.
...
Next: [Trade Desk](/trade-desk) | [How Systems Work](/how-systems-work) | [Profile And Identity](/profile-and-identity)
