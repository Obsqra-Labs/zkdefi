const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CwrWob4T.js","assets/chunks/framework.Bk4d7gLa.js","assets/chunks/mermaid.core.PiF7Ag_s.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, c as createElementBlock, r as renderSlot, n as normalizeClass, o as openBlock, a as createTextVNode, t as toDisplayString, b as createBlock, w as withCtx, T as Transition, e as createCommentVNode, _ as _export_sfc, u as useData$1, i as isExternal, f as treatAsHtml, g as withBase, h as computed, j as createBaseVNode, k as unref, l as isActive, m as useMediaQuery, p as ref, q as watch, s as watchEffect, v as onMounted, x as onUnmounted, y as watchPostEffect, z as onUpdated, A as getScrollOffset, F as Fragment, B as renderList, C as resolveComponent, D as onContentUpdated, E as createVNode, G as shallowRef, H as resolveDynamicComponent, I as EXTERNAL_URL_RE, J as useRoute, K as mergeProps, L as inject, M as useWindowSize, N as normalizeStyle, O as onKeyStroke, P as nextTick, Q as useWindowScroll, R as inBrowser, S as readonly, U as defineAsyncComponent, V as __vitePreload, W as useScrollLock, X as provide, Y as toHandlers, Z as withKeys, $ as onBeforeUnmount, a0 as withModifiers, a1 as useSlots } from "./framework.Bk4d7gLa.js";
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CwrWob4T.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
function normalizeMermaidCodeFences() {
  var _a;
  const codeFences = Array.from(
    document.querySelectorAll(".vp-doc .language-mermaid")
  );
  for (const fence of codeFences) {
    const code = fence.querySelector("code");
    const source = (_a = code == null ? void 0 : code.textContent) == null ? void 0 : _a.trim();
    if (!source) continue;
...
async function renderMermaidDiagrams() {
  ...
  if (!mermaidPromise) {
    mermaidPromise = __vitePreload(() => import("./mermaid.core.PiF7Ag_s.js").then((n) => n.bI), true ? __vite__mapDeps([2,1]) : void 0);
  }
  ...
  const nodes = Array.from(
    document.querySelectorAll(".vp-doc .mermaid")
  );
