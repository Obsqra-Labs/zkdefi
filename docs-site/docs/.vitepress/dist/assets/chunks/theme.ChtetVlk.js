const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.4iBtSxwK.js","assets/chunks/framework.Bk4d7gLa.js","assets/chunks/mermaid.core.BcAYFjNO.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.4iBtSxwK.js"), true ? __vite__mapDeps([0,1]) : void 0));
