import { aI as adjustChannel, s as setAccDescription, g as getAccDescription, t as getDiagramTitle, q as setDiagramTitle, a as getAccTitle, b as setAccTitle, _ as __name, I as getConfig, L as selectSvgElement, d as select, as as at, ad as isDark, ae as lighten, af as darken, e as configureSvgSize, A as clear, G as cleanAndMerge, H as defaultConfig_default } from "./mermaid.core.BcAYFjNO.js";
...
var draw = /* @__PURE__ */ __name((_text, id, _version, diagObj) => {
  ...
  dummyD3root.selectAll(".venn-circle").each(function(d, i) {
    ...
    const textColor = (customStyle == null ? void 0 : customStyle.color) || (themeDark ? lighten(baseColor, 30) : darken(baseColor, 30));
