...
BRIDGE_TIMEOUT_OVERRIDE="${SHOWCASE_BRIDGE_TIMEOUT_SECONDS:-}"
DUAL_TIMEOUT_OVERRIDE="${SHOWCASE_DUAL_BRIDGE_TIMEOUT_SECONDS:-}"
NOIR_TIMEOUT_OVERRIDE="${SHOWCASE_NOIR_BRIDGE_TIMEOUT_SECONDS:-}"
