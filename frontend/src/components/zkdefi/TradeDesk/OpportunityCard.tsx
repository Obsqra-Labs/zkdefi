        ...
        <div className={`p-4 ${recommended ? "pt-10" : ""}`}>
          ...
          <div className="flex items-center gap-1 mb-3">
            ...
            {opportunity.privacyLevel === "shielded" && (
              <span className="p-1.5 bg-blue-100 rounded border border-blue-200" title="Private">
                <Lock className="w-3 h-3 text-blue-600" />
              </span>
            )}
            {opportunity.privacyLevel === "fully_private" && (
              <span className="p-1.5 bg-purple-100 rounded border border-purple-200" title="Private+">
