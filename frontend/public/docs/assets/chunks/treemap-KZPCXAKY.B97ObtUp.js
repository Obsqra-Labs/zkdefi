...
import { bF as createAssigner, bG as isPrototype, aU as isArrayLike, bp as copyObject, aY as assignValue, aV as isArray, at as baseRest, au as isArrayLikeObject, bf as baseAssignValue, bi as isObjectLike, bj as baseGetTag, bg as baseUnary, bu as nodeUtil, aw as isFunction, ax as isEmpty, aW as identity, aQ as isObject, aL as commonjsGlobal, bH as getAugmentedNamespace } from "./mermaid.core.PiF7Ag_s.js";
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from "./baseUniq.GTRqyuqc.js";
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, h as has, i as defaults, l as last, e as min } from "./basePickBy.7xd8muYd.js";
import { c as clone } from "./clone.NfykPgLh.js";
...
function createAggregator(setter, initializer) {
  return function(collection, iteratee) {
    ...
    return func2(collection, setter, baseIteratee(iteratee), accumulator);
  };
}
var LARGE_ARRAY_SIZE = 200;
function baseDifference(array2, values2, iteratee, comparator) {
  var index = -1, includes2 = arrayIncludes, isCommon = true, length = array2.length, result = [], valuesLength = values2.length;
  if (!length) {
    return result;
  }
  ...
  outer:
    while (++index < length) {
      var value = array2[index], computed = value;
...
function every(collection, predicate, guard) {
  ...
  return func2(collection, baseIteratee(predicate));
}
...
function reject(collection, predicate) {
  ...
  return func2(collection, negate(baseIteratee(predicate)));
}
...
class AbstractAstReflection {
  ...
  getReferenceType(refInfo) {
    ...
    const referenceType = (_a2 = metaData.properties[refInfo.property]) == null ? void 0 : _a2.referenceType;
    if (!referenceType) {
...
function isAstNodeInRange(astNode, range) {
  ...
  const nodeRange = (_a2 = astNode.$cstNode) == null ? void 0 : _a2.range;
  if (!nodeRange) {
    return false;
  }
...
function findAssignment(cstNode) {
  ...
  while (astNode === ((_a2 = cstNode.container) == null ? void 0 : _a2.astNode)) {
...
function findNameAssignmentInternal(type, startNode, cache) {
  ...
  for (const node of streamAllContents(startNode)) {
    ...
    } else if (isSimpleType(node) && ((_a2 = node.typeRef) == null ? void 0 : _a2.ref)) {
...
function getActionType(action) {
  ...
  } else if ((_a2 = action.type) == null ? void 0 : _a2.ref) {
...
function getRuleType(rule) {
  var _a2;
  if (isTerminalRule(rule)) {
    return ((_a2 = rule.type) == null ? void 0 : _a2.name) ?? "string";
  } else {
...
function abstractElementToRegex(element, flags) {
  ...
  if (isTerminalAlternatives(element)) {
    ...
    throw new Error(`Invalid terminal element: ${element == null ? void 0 : element.$type}, ${(_a2 = element == null ? void 0 : element.$cstNode) == null ? void 0 : _a2.text}`);
  }
}
...
(function(Range2) {
  function create(one, two, three, four) {
    if (Is$3.uinteger(one) && Is$3.uinteger(two) && Is$3.uinteger(three) && Is$3.uinteger(four)) {
...
(function(FoldingRange2) {
  function create(startLine, endLine, startCharacter, endCharacter, kind, collapsedText) {
    ...
    if (Is$3.defined(startCharacter)) {
      result.startCharacter = startCharacter;
    }
    if (Is$3.defined(endCharacter)) {
      result.endCharacter = endCharacter;
    }
    if (Is$3.defined(kind)) {
      result.kind = kind;
    }
    if (Is$3.defined(collapsedText)) {
...
(function(Diagnostic2) {
  function create(range, message, severity, code, source, relatedInformation) {
    ...
    if (Is$3.defined(severity)) {
      result.severity = severity;
    }
    if (Is$3.defined(code)) {
      result.code = code;
    }
    if (Is$3.defined(source)) {
      result.source = source;
    }
    if (Is$3.defined(relatedInformation)) {
  ...
  function is2(value) {
    var _a2;
    let candidate = value;
    return Is$3.defined(candidate) && Range.is(candidate.range) && Is$3.string(candidate.message) && (Is$3.number(candidate.severity) || Is$3.undefined(candidate.severity)) && (Is$3.integer(candidate.code) || Is$3.string(candidate.code) || Is$3.undefined(candidate.code)) && (Is$3.undefined(candidate.codeDescription) || Is$3.string((_a2 = candidate.codeDescription) === null || _a2 === void 0 ? void 0 : _a2.href)) && (Is$3.string(candidate.source) || Is$3.undefined(candidate.source)) && (Is$3.undefined(candidate.relatedInformation) || Is$3.typedArray(candidate.relatedInformation, DiagnosticRelatedInformation.is));
  }
  Diagnostic2.is = is2;
...
(function(Command2) {
  function create(title, command, ...args) {
    ...
    if (Is$3.defined(args) && args.length > 0) {
...
(function(SignatureInformation2) {
  function create(label, documentation, ...parameters) {
    let result = { label };
    if (Is$3.defined(documentation)) {
      result.documentation = documentation;
    }
    if (Is$3.defined(parameters)) {
...
(function(SelectionRange2) {
  ...
  function is2(value) {
    let candidate = value;
    return Is$3.objectLiteral(candidate) && Range.is(candidate.range) && (candidate.parent === void 0 || SelectionRange2.is(candidate.parent));
  }
...
class AbstractCstNode {
  ...
  get astNode() {
    var _a2, _b2;
    const node = typeof ((_a2 = this._astNode) == null ? void 0 : _a2.$type) === "string" ? this._astNode : (_b2 = this.container) == null ? void 0 : _b2.astNode;
    if (!node) {
...
class AbstractLangiumParser {
  constructor(services) {
    ...
    if ((_a2 = services.shared.profilers.LangiumProfiler) == null ? void 0 : _a2.isActive("parsing")) {
...
function buildRuleCallPredicate(rule, namedArgs) {
  ...
  if (hasNamedArguments) {
    const namedPredicates = namedArgs.map((arg) => {
      var _a2, _b2;
      return {
        parameterName: (_b2 = (_a2 = arg.parameter) == null ? void 0 : _a2.ref) == null ? void 0 : _b2.name,
...
class DefaultValueConverter {
  ...
  runConverter(rule, input, cstNode) {
    ...
    switch ((_a2 = getRuleType(rule)) == null ? void 0 : _a2.toLowerCase()) {
      case "number":
...
(function(CancellationToken2) {
  ...
  function is2(value) {
    const candidate = value;
    return candidate && (candidate === CancellationToken2.None || candidate === CancellationToken2.Cancelled || Is$2.boolean(candidate.isCancellationRequested) && !!candidate.onCancellationRequested);
  }
...
class UriTrie {
  ...
  has(uri) {
    var _a2;
    return ((_a2 = this.getNode(this.normalizeUri(uri), false)) == null ? void 0 : _a2.element) !== void 0;
  }
  hasNode(uri) {
  ...
  find(uri) {
    var _a2;
    return (_a2 = this.getNode(this.normalizeUri(uri), false)) == null ? void 0 : _a2.element;
  }
  findNode(uri) {
...
class DefaultLangiumDocumentFactory {
  ...
  async update(document, cancellationToken) {
    var _a2, _b2;
    const oldText = (_a2 = document.parseResult.value.$cstNode) == null ? void 0 : _a2.root.fullText;
...
class DefaultLinker {
  ...
  async link(document, cancelToken = CancellationToken_1.None) {
    var _a2;
    if ((_a2 = this.profiler) == null ? void 0 : _a2.isActive("linking")) {
  ...
  replacer(key, value, { refText, sourceText, textRegions, comments, uriConverter }) {
    ...
    if (this.ignoreProperties.has(key)) {
      ...
      if (refValue) {
        ...
        return {
          $error: ((_a2 = value.error) == null ? void 0 : _a2.message) ?? "Could not resolve reference",
          $refText
        };
      }
...
class DefaultServiceRegistry {
  ...
  getServices(uri) {
    ...
    const languageId = (_b2 = (_a2 = this.textDocuments) == null ? void 0 : _a2.get(uri)) == null ? void 0 : _b2.languageId;
...
class DefaultDocumentValidator {
  ...
  async validateDocument(document, options = {}, cancelToken = CancellationToken_1.None) {
    ...
    if (!options.categories || options.categories.includes("built-in")) {
      ...
      if (options.stopAfterLexingErrors && diagnostics.some((d) => {
        var _a2;
        return ((_a2 = d.data) == null ? void 0 : _a2.code) === DocumentValidator.LexingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterParsingErrors && diagnostics.some((d) => {
        var _a2;
        return ((_a2 = d.data) == null ? void 0 : _a2.code) === DocumentValidator.ParsingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterLinkingErrors && diagnostics.some((d) => {
        var _a2;
        return ((_a2 = d.data) == null ? void 0 : _a2.code) === DocumentValidator.LinkingError;
      })) {
        return diagnostics;
      }
    }
  ...
  processLexingErrors(parseResult, diagnostics, _options) {
    var _a2;
    const lexerDiagnostics = [...parseResult.lexerErrors, ...((_a2 = parseResult.lexerReport) == null ? void 0 : _a2.diagnostics) ?? []];
    ...
    for (const reference of document.references) {
      ...
      if (linkingError) {
        const info = {
          ...
          range: (_a2 = reference.$refNode) == null ? void 0 : _a2.range,
  ...
  async validateAstNodes(rootNode, options, acceptor, cancelToken = CancellationToken_1.None) {
    var _a2;
    if ((_a2 = this.profiler) == null ? void 0 : _a2.isActive("validating")) {
...
class DefaultConfigurationProvider {
  ...
  initialize(params) {
    var _a2;
    this.workspaceConfig = ((_a2 = params.capabilities.workspace) == null ? void 0 : _a2.configuration) ?? false;
  }
...
function requireSemaphore() {
  ...
  class Semaphore {
    ...
    runNext() {
      ...
      (0, ral_12.default)().timer.setImmediate(() => this.doRunNext());
    }
    doRunNext() {
      if (this._waiting.length === 0 || this._active === this._capacity) {
        return;
...
function requireMessageWriter() {
  ...
  (function(ResolvedMessageWriterOptions2) {
    function fromOptions(options) {
      if (options === void 0 || typeof options === "string") {
        return { charset: options ?? "utf-8", contentTypeEncoder: (0, ral_12.default)().applicationJson.encoder };
      } else {
        return { charset: options.charset ?? "utf-8", contentEncoder: options.contentEncoder, contentTypeEncoder: options.contentTypeEncoder ?? (0, ral_12.default)().applicationJson.encoder };
      }
    }
...
function requireConnection() {
  ...
  (function(exports$1) {
    ...
    const ral_12 = ral;
    const Is2 = is$1;
    const messages_12 = requireMessages();
...
class DefaultDocumentBuilder {
        ...
        if (typeof options.validation === "boolean" && options.validation) {
          ...
          if (categories.length > 0) {
            this.buildState.set(key, {
              ...
              result: (_a2 = this.buildState.get(key)) == null ? void 0 : _a2.result
            });
  ...
  async update(changed, deleted, cancelToken = CancellationToken_1.None) {
    ...
    const rebuildDocuments = this.sortDocuments(this.langiumDocuments.all.filter((doc) => {
      ...
      return (
        ...
        doc.state < DocumentState.Validated || !((_a2 = this.buildState.get(doc.uri.toString())) == null ? void 0 : _a2.completed) || this.resultsAreIncomplete(doc, this.updateBuildOptions)
      );
    }).toArray());
  ...
  findMissingValidationCategories(document, options) {
    ...
    const executedCategories = ((_a2 = state == null ? void 0 : state.result) == null ? void 0 : _a2.validationChecks) ? new Set((_b2 = state == null ? void 0 : state.result) == null ? void 0 : _b2.validationChecks) : (state == null ? void 0 : state.completed) ? allCategories : /* @__PURE__ */ new Set();
  ...
  async findChangedUris(changed) {
    var _a2;
    const document = this.langiumDocuments.getDocument(changed) ?? ((_a2 = this.textDocuments) == null ? void 0 : _a2.get(changed));
    if (document) {
      return [changed];
    }
    try {
  ...
  hasTextDocument(doc) {
    var _a2;
    return Boolean((_a2 = this.textDocuments) == null ? void 0 : _a2.get(doc.uri));
  }
  /**
  ...
  getBuildOptions(document) {
    var _a2;
    return ((_a2 = this.buildState.get(document.uri.toString())) == null ? void 0 : _a2.options) ?? {};
  }
}
...
class DefaultLexer {
  ...
  tokenize(text, _options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    return {
      ...
      report: (_b2 = (_a2 = this.tokenBuilder).flushLexingReport) == null ? void 0 : _b2.call(_a2, text)
    };
  }
...
function isJSDoc(node, options) {
  ...
  return Boolean(firstRegex == null ? void 0 : firstRegex.exec(first2)) && Boolean(lastRegex == null ? void 0 : lastRegex.exec(last2));
}
...
function tokenize(context) {
  ...
  for (let i = 0; i < context.lines.length; i++) {
    ...
    if (first2 && context.options.start) {
      const match = (_a2 = context.options.start) == null ? void 0 : _a2.exec(line);
      if (match) {
...
function parseJSDocComment(context) {
  ...
  const start = ((_a2 = elements[0]) == null ? void 0 : _a2.range.start) ?? startPosition;
...
${content}`;
  ...
  toMarkdown(options) {
    var _a2;
    return ((_a2 = options == null ? void 0 : options.renderTag) == null ? void 0 : _a2.call(options, this)) ?? this.toMarkdownDefault(options);
  }
...
function renderInlineTag(tag, content, options) {
  ...
  if (tag === "linkplain" || tag === "linkcode" || tag === "link") {
    ...
    const renderedLink = ((_a2 = options.renderLink) == null ? void 0 : _a2.call(options, content, display)) ?? renderLinkDefault(content, display);
    return renderedLink;
  }
  return void 0;
}
...
class DefaultCommentProvider {
  ...
  getComment(node) {
    ...
    return (_a2 = findCommentNode(node.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : _a2.text;
  }
}
