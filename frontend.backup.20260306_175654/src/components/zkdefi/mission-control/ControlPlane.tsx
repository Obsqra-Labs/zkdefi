        ...
        <div className="space-y-2 text-xs">
          {activeSession ? (
            <>
              ...
              <button className="w-full py-1.5 text-xs font-medium rounded border border-red-800/60 text-red-400 hover:bg-red-950/30 transition-colors">
                Revoke
              </button>
            </>
          ) : (
            <>
              ...
              <p className="text-zinc-500 text-[11px]">
                Create a session key to enable autonomous execution.
              </p>
            </>
          )}
        </div>
