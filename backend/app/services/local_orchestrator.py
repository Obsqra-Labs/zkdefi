...
# Built-in model registry - zkde.fi owns these
MODELS = {
    "risk_scoring": {
        "id": "risk_scoring",
        "name": "Risk Score",
    ...
    "credit_scoring": {
        ...
        "type": "risc_zero",  # Uses RISC Zero zkVM for neural network inference
        "service": "risc_zero_credit_service",
        "timeout": 300.0,
        "default_threshold": 600,  # Minimum credit score (600 = tier A or better)
    },
}
